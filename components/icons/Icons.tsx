...
export const DadIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 5c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3m0 11.5c-3.14 0-6-1.5-6-3.5 0-1.42.79-2.68 2-3.32.53-.28 1.15-.46 1.83-.46h4.34c.68 0 1.3.18 1.83.46 1.21.64 2 1.9 2 3.32 0 2-2.86 3.5-6 3.5z" /></svg>
);

export const Footprints: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 16.8V12a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1v4.8" /><path d="M6 20.8c.4 0 .8-.4.8-.8V12a1 1 0 1 1 2 0v8.8" /><path d="M8 17.8c.4 0 .8-.4.8-.8V12a1 1 0 1 1 2 0v5.8" /><path d="M10 14.8c.4 0 .8-.4.8-.8V12a1 1 0 1 1 2 0v2.8" /><path d="M12 20a1 1 0 0 0-1-1H9.5a1 1 0 0 0-1 1" /><path d="M15.5 20a1 1 0 0 0-1-1h-1a1 1 0 0 0-1 1" /><path d="M18.5 16.8c.4 0 .8-.4.8-.8V12a1 1 0 1 1 2 0v4.8" /><path d="M21.5 13.8c.4 0 .8-.4.8-.8V12a1 1 0 1 1 2 0v1.8" /></svg>
);

export const HeartPulse: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 12h-4l-3 9L9 3l-3 9H2" /><path d="M12 20.84c-.23.23-.48.45-.73.65A10.26 10.26 0 0 1 2 12c0-5.52 4.48-10 10-10s10 4.48 10 10c0 .34-.02.68-.05 1.02" /></svg>
);
...
export const MomIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 5c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3m0 14.5c-3.14 0-6-2-6-4.5 0-1.63.81-3.08 2.1-3.92.5-.33 1.15-.58 1.9-.58h4c.75 0 1.4.25 1.9.58 1.29.84 2.1 2.29 2.1 3.92 0 2.5-2.86 4.5-6 4.5z" /></svg>
);
...
export const Stethoscope: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M8 3a4 4 0 0 0-4 4v11a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v4a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V7a4 4 0 0 0-4-4z"/><circle cx="12" cy="19" r="2"/></svg>
);

export const Syringe: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M18 6L6 18" /><path d="m13 11 9-9" /><path d="m7 7-4 4" /><path d="m17 11 4-4" /><path d="m21 7-4 4" /><path d="m14 1 3 3" /><path d="M3 21l3-3" /></svg>
);
...
// Badge Icons
export const FirstStepsBadge: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z" /><path d="M9 12l2 2 4-4" /></svg>
);

export const VaccinationHeroBadge: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><path d="m13.5 9-4 4" /><path d="m11 13 4 4" /><path d="m10.5 16 -4-4" /></svg>
);

export const GrowthTrackerBadge: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z" /><path d="M16 12l-4 4-4-4" /><path d="M12 8v8" /></svg>
);

export const FeedingExpertBadge: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z" /><path d="m14 8-1.15 1.15a1 1 0 0 1-1.42 0L10 8" /><path d="M12 14v-4" /><path d="m12 14 2 2.5-4 2.5 2-5Z" /></svg>
);

export const CommunityStarBadge: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z" /><path d="m12 15.5-2.5 1.5 1-3-2.5-2 3.5-.5L12 8l1.5 3.5 3.5.5-2.5 2 1 3Z" /></svg>
);

export const ANCChampionBadge: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z" /><path d="M8 3a4 4 0 0 0-4 4v11a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v4a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V7a4 4 0 0 0-4-4z" transform="scale(0.5) translate(12, 1)"/></svg>
);